...
const steps: [string, string, string[]][] = [
  ...
  [
    ...
    [
      ...
      "packages/client-runtime/src/connection/errors.hub.test.ts",
      "packages/client-runtime/src/connection/errors.test.ts",
      "packages/client-runtime/src/connection/presentation.test.ts",
      "apps/web/src/components/HubProjects.test.tsx",
      "apps/web/src/components/settings/HubEnvironments.test.tsx",
